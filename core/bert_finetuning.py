...
print(' Original: ', qars[0])

# Print the sentence split into tokens.
print('Tokenized: ', tokenizer.tokenize(qars[0]))

# Print the sentence mapped to token ids.
print('Token IDs: ', tokenizer.convert_tokens_to_ids(tokenizer.tokenize(qars[0])))
...
for qar in qars:
    ...
    encoded_qar = tokenizer.encode(
                        qar,                      # Sentence to encode.
